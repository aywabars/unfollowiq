  ...
  async loginWithCredentials(username, password) {
    ...
    if (loginData.checkpoint_url || loginData.message === 'checkpoint_required') {
      ...
      try {
        ...
        console.log('[CHALLENGE] GET challenge page data:', JSON.stringify(challengeRes.data).substring(0, 500));

        // Step 2: Request the verification code
        // choice=1 typically sends to phone/WhatsApp, choice=0 sends to email
        // Try choice=1 first for phone
